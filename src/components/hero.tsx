export default function Hero() {
  return (
    <div className="relative bg-midnight-green overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 py-[120px] max-w-5xl px-6 mx-auto">
        <div>
          <h1 className="font-bold text-[40px] sm:text-[64px] leading-[40px] sm:leading-[56pxpx] md:leading-[100px] text-center md:text-left text-white mb-4 sm:mb-6">About</h1>
        </div>
